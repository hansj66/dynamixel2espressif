...
#ifndef DYNAMIXEL_2_ESPRESSIF_H_
#define DYNAMIXEL_2_ESPRESSIF_H_
...
// https://github.com/ROBOTIS-GIT/Dynamixel2Espressif/issues/73
enum OperatingMode{
  OP_CURRENT = 0,
  OP_VELOCITY = 1,
  OP_POSITION = 3,
...
class Dynamixel2Espressif : public DYNAMIXEL::Master
{
  public:
    /**
     * @brief The constructor.
     * @code
     * Dynamixel2Espressif dxl;
     * @endcode
     */   
    Dynamixel2Espressif(uint16_t packet_buf_size = DEFAULT_DXL_BUF_LENGTH);

    /**
     * @brief The constructor.
     * @code
     * const int DXL_DIR_PIN = 2;
     * Dynamixel2Espressif dxl(Serial1, DXL_DIR_PIN);
     * @endcode
     ...
     */   
    Dynamixel2Espressif(uart_port_t uart_num, gpio_num_t dir_pin, uint16_t packet_buf_size = DEFAULT_DXL_BUF_LENGTH);
...
#endif /* DYNAMIXEL_2_ESPRESSIF_H_ */
